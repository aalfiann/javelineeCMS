...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['pinger_setting'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['pinger_setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
        ...
        <section id="content">
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              <div class="well">
              <p><?=$lang['pinger_info']?></p></div>
              <?php include $root.'/acp/apps/pinger/form.php'; ?>
