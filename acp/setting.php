...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['setting'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
