...
include 'mediaconfig.php'; 	echo search_img(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['result_search_images'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['result_search_images'] ?> | <?= $site['title'] ?> Admin Control Panel" />
          ...
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              <?php include 'form.media.php'; ?>
                      ...
                      <li><a href="<?php if ($noPage > 1) echo $_SERVER['PHP_SELF'].'?q='.$search_img.'&page='.($noPage-1) ?>" class="btn btn-default"><i class="i i-arrow-left4"></i></a></li>
							 <li><a href="#"><?= $lang['page'] ?> <?= $noPage ?></a></li>                      
                      <li><a href="<?= $_SERVER['PHP_SELF'].'?q='.$search_img.'&page='.($noPage+1) ?>" class="btn btn-default"><i class="i i-arrow-right4"></i></a></li>
                    </ul>
                    <div class="pull-right"><?= $lang['images_found'] ?> = <strong><?= $jumData?></strong></div>
            </section>
