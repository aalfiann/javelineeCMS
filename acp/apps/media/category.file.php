...
include 'mediaconfig.php'; echo category_file(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['category_file'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['category_file'] ?> | <?= $site['title'] ?> Admin Control Panel" />
