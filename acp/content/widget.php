...
include $root.'/acp/model/widget.pagination.php'; 
include_once $root.'/acp/model/set.lang.php'; echo ViewWidget(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['list_widget'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['list_widget'] ?> | <?= $site['title'] ?> Admin Control Panel" />
