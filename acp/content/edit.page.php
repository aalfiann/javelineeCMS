...
include_once $root.'/acp/model/set.lang.php'; echo EditPage(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['edit_page'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['edit_page'] ?> | <?= $site['title'] ?> Admin Control Panel" />
        ...
        <section id="content">
          <section class="vbox">
            ...
            <div class="row wrapper">
            	<?php include 'form.edit.page.php' ?>
            </div>
