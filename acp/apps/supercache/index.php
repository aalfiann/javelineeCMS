...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['supercache_setting'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['supercache_setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
          ...
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              <div class="alert alert-warning">
                    ...
                    <i class="fa fa-ban-circle"></i><?= $lang['supercache_warning'] ?>
                  </div>
              <?php include $root.'/acp/apps/supercache/form.php'; ?>
