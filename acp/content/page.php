...
include_once $root.'/acp/model/set.lang.php'; echo data_page(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['static_page'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['static_page'] ?> | <?= $site['title'] ?> Admin Control Panel" />
