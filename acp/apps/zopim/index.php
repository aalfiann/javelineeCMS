<?php 
  ...
  include $root.'/acp/model/zopim.php'; 
  include_once $root.'/acp/model/set.lang.php';

// Parameter for editing
	$titlelayout = $lang['zopim_setting']." | ".$site['title'];
	$savebutton = "save_zopim";
	echo LiveChat($layout = "embed.php"); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['zopim_setting'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['zopim_setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
        ...
        <section id="content">
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              ...
              <?php include $root.'/acp/apps/zopim/form.php'; ?>
