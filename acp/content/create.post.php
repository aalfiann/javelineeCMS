...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['create_new_post'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['create_new_post'] ?> | <?= $site['title'] ?> Admin Control Panel" />
        ...
        <section id="content">
          <section class="vbox">
            ...
            <div class="row wrapper">
            	<?php include 'form.create.post.php' ?>
            </div>  
