...
include 'mediaconfig.php'; echo data_file(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['media_file'] ?> - <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['media_file'] ?> | <?= $site['title'] ?> Admin Control Panel" />
        ...
        <section id="content">
          <section class="vbox">
            <header class="header bg-light lt b-b b-light">
              ...
              <form action="search.file.php" method="get" class="m-t-sm pull-right pull-none-xs input-s-lg m-b-sm">
