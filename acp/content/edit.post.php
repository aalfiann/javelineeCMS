<?php 
  ...
  include_once $root.'/acp/model/set.lang.php'; echo EditPost(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['edit_post'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['edit_post'] ?> | <?= $site['title'] ?> Admin Control Panel" />
  <script src="<?= $host.'/acp/js/ckeditor/ckeditor.js'; ?>"></script>
        ...
        <section id="content">
          <section class="vbox">
            ...
            <div class="row wrapper">
            	<?php include 'form.edit.post.php' ?>
            </div>
