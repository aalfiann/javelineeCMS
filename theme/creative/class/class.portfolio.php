		...
		public static function Load($item){
			// Default show portfolio
            	...
            	<div class="text-center">
					<input type="submit" value="Load More" id="load_more_button" class="btn btn-default load_more"/>
                    ...
                    <div class="project-wrapper">
                        <div class="project">
                            <div class="photo-wrapper">
                                <div class="photo">
                                    <a class="fancybox" href="'.$host.$datafolio['url_img'].'">
                                    <img class="img-responsive" src="'.$host.$datafolio['url_img'].'" alt="'.stripcslashes($datafolio['alt_img']).'"></a>
                                </div>
