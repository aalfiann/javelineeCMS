...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['recaptcha_setting'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['recaptcha_setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
          ...
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              <div class="alert alert-warning">
                    ...
                    <i class="fa fa-ban-circle"></i><?= $lang['recaptcha_help'] ?>
                  </div>
              <?php include $root.'/acp/apps/recaptcha/form.php'; ?>
