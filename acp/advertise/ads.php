...
include $root.'/acp/model/ads.pagination.php'; 
include_once $root.'/acp/model/set.lang.php'; echo ViewAds(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['list_ads'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['list_ads'] ?> | <?= $site['title'] ?> Admin Control Panel" />
