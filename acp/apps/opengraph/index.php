...
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['ogp_plugin'] ?> | <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['ogp_setting'] ?> | <?= $site['title'] ?> Admin Control Panel" />
          ...
          <section class="vbox">
            ...
            <section class="scrollable wrapper w-f">
              <div class="alert alert-warning">
                    ...
                    <i class="fa fa-ban-circle"></i><?= $lang['opengraph_help'] ?>
                  </div>
              <?php include $root.'/acp/apps/opengraph/form.php'; ?>
