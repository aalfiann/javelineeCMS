<?php session_start();  include 'config.php'; include 'config.seo.php'; include 'config.s.seo.php'; include_once 'model/set.lang.php'; include 'model/check.php'; include 'model/admin.only.php'; ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['seo_setting']; ?> - <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['seo_setting']; ?> - <?= $site['title'] ?>" />
