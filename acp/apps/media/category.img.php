...
include 'mediaconfig.php'; echo category_img(); ?>

<!DOCTYPE html>
<html lang="en" class="app">
<head>  
  <meta charset="utf-8" />
  <title><?= $lang['category_images'] ?> - <?= $site['title'] ?> Admin Control Panel</title>
  <meta name="description" content="<?= $lang['category_images'] ?> | <?= $site['title'] ?> Admin Control Panel" />
